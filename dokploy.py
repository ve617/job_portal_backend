...
API_URL = "http://13.235.216.0:3000/api/project.all"
api_key = "qwOsvzywKIaVfcteFPcKQIOgOkWoOjcUJTaidJyITyxhubqeDRIllwhyDBVtXIZd"
app_name = "job-portal-backend-7dhkxu"
